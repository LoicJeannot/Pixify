...
const darkMode = () => {
    const highlightedButtons = document.querySelector(".submitnow_button");
    body.classList.add("dark_mode");
    body.classList.remove("light_mode");
    darkButton.classList.add("hidden")
    lightButton.classList.remove("hidden");
    highlightedButtons.style.border = "#7BFFE9 solid 1px";
}
...
const lightMode = () => {
    ...
    highlightedButtons.style.border = "none";
}
...
const displayImages = (list) => {
    ...
    imageContainer.innerHTML = Pictures;
}
